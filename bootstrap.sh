...
sudo echo -e "<VirtualHost *:80>
    ...
    ErrorLog /vagrant/apache2_aterrochat.log
</VirtualHost>" >> /etc/apache2/sites-available/aterrochat.conf
sudo a2ensite aterrochat.conf
sudo service apache2 restart
